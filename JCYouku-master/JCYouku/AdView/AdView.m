...
//    //上面的灰色遮罩
//    UIView *vv = [[UIView alloc] initWithFrame:CGRectMake(0, kAdViewHeight - 44, kAdViewWidth, 44)];
...
//    [self bringSubviewToFront:_pageControl];
    ...
    if (!_centerAdLabel) {
        ...
        _centerAdLabel.frame = CGRectMake(10, kAdViewHeight - 44, kAdViewWidth - 10, 44);
        _centerAdLabel.textColor = [UIColor whiteColor];
        _centerAdLabel.font = [UIFont systemFontOfSize:13];
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    {
        _pageControl.frame = CGRectMake(0, kAdViewHeight - 44 - 10, 20 *_pageControl.numberOfPages, 20);
